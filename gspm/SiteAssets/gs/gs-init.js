...
GSPMS.item = null;
GSPMS.workflow = null;
GSPMS.currentUser = null;
GSPMS.workflowName = "Approbation 2010";
//GSPMS.wfDefinitionId = "{d6fed34a-2214-47c0-a0b6-8779e8eb2379}";
GSPMS.wfDefinitionId = "{67786373-1EA1-452B-8495-2EB736BB0703}";
...
GSPMS.getItem = function () {
    GSPMS.web = GSPMS.context.get_web();
    GSPMS.list = GSPMS.web.get_lists().getById(GSPMS.listId);
    GSPMS.item = GSPMS.list.getItemById(GSPMS.itemId);
    GSPMS.currentUser = GSPMS.web.get_currentUser();

    GSPMS.context.load(GSPMS.item);
    GSPMS.context.load(GSPMS.currentUser);

    GSPMS.context.executeQueryAsync(function () {
        GSPMS.getManagerInfo();
...
GSPMS.getManagerInfo = function () {
    // get selected manager info
    var managerName = GSPMS.item.get_item("Manager").get_lookupValue();
    var managerId = GSPMS.item.get_item("Manager").get_lookupId();
...
GSPMS.triggerWF = function (item, xml) {
    ...
    itemUniqueId = GSPMS.item.get_item("UniqueId").toString();
    itemGuid = GSPMS.item.get_item("GUID").toString();
...
GSPMS.checkSelectedItem = function () {
